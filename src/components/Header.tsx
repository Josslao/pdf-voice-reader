...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 glass-ios18 border-b border-black/[0.04] safe-top safe-x">
      <div className="mx-auto flex h-12 max-w-[980px] items-center justify-between px-4 sm:px-5">
        ...
        {/* 设置按钮:在 Android 上确保有足够触控区,不被状态栏遮挡 */}
        <button
          type="button"
          className="btn-icon btn-icon-mobile touch-ios18 relative z-40"
